...
<body>
  <div class="info" > <?Php echo '<label for="">Organazation ID :'.$emp_id.'</label><br><label for="">Owner Name :'.$ownername.'</label>'?>   </div> 
  <div id="button" style="">
    ...
    <div class="dropdown" style=margin-left:30px;>
        <button class="btn btn-danger"  type="button" id="dropdownMenuButton"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img src="https://i.ibb.co/9WNg1Qf/chicken.png" height="50"/></button>
        ...
        <div class="dropdown-menu"type="button" data-toggle="modal" data-target="#exampleModal" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" type="button" data-toggle="modal" data-target="#exampleModal" href="#">Per Bird Cost</a>
    ...
    <div class="dropdown" style=" position:relative; margin-top:50px ; left: -355px; ">
      ...
      <div class="dropdown-menu" type="button" data-toggle="modal" data-target="#exampleModal" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" type="button" data-toggle="modal" data-target="#exampleModal" href="#">Chicken Sale</a>
        <a class="dropdown-item" type="button" data-toggle="modal" data-target="#exampleModal" href="#">Chicken Purchase</a>
